...
const WordCounter = () => {
  ...
  return (
    <SEOWrapper
      ...
      description="Free online word counter tool. Count words, characters, sentences, paragraphs, and estimate reading time for any text instantly."
      keywords="word counter, character counter, text analysis, reading time calculator, writing tools"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Analyze your text with detailed statistics. Count words, characters, sentences, 
            paragraphs, and get reading time estimates instantly.
          </p>
        </div>
          ...
          <div className="lg:col-span-3">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Word density:</span>
                      <Badge variant="outline">
                        {stats.characters > 0 ? Math.round((stats.words / stats.characters) * 1000) / 10 : 0}%
                      </Badge>
                    </div>
                  </div>
                </div>
            ...
            <Card className="mt-8">
              ...
              <CardContent className="prose prose-sm max-w-none dark:prose-invert">
                <p>
                  This word counter tool provides comprehensive text analysis to help writers, 
                  students, and professionals track their writing progress and ensure content 
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  ...
                  <div className="text-muted-foreground">15-20 words for readability</div>
                </div>
                <div>
                  <div className="font-medium">Blog post length:</div>
                  <div className="text-muted-foreground">1,500-2,000 words for SEO</div>
                </div>
                <div>
                  <div className="font-medium">Reading speed:</div>
                  <div className="text-muted-foreground">200-250 words per minute</div>
                </div>
                <div>
                  <div className="font-medium">Tweet length:</div>
                  <div className="text-muted-foreground">280 characters max</div>
                </div>
              </CardContent>
            </Card>
          </div>
